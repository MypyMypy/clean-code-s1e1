...
var createNewTaskElement = function (taskString) {
  ...
  label.className = "todo-item__description";
  ...
  editInput.type = "text";
  editInput.className = "todo-item__input task";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "todo-item__button--edit todo-button";

  deleteButton.className = "todo-item__button--delete todo-button";
